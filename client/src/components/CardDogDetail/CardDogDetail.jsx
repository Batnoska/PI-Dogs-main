...
// Modulos internos
import { getDescription, getClean, setLoading, deleteDog } from "../../redux/actions/actions";
...
function CardDogDetail() {
    ...
    const { name, weightMin, weightMax, heightMin, heightMax, life_spanMax, life_spanMin, image, temperament, createdInDb } = dogDescription;
